...
1. 解压 `单据排版打印台-Chrome试用版-v0.3.0.zip`。
2. 在 Chrome 地址栏打开 `chrome://extensions/`。
3. 打开右上角“开发者模式”。
4. 点击“加载已解压的扩展程序”。
5. 选择解压后的 `单据排版打印台-Chrome试用版-v0.3.0` 文件夹。
...
3. 在飞书表格中勾选要打印的记录；插件会用官方 SDK 读取主记录和关联明细。
4. 飞书插件状态栏出现“Chrome 已同步”后，点击 Chrome 工具栏里的“单据排版打印台”。
